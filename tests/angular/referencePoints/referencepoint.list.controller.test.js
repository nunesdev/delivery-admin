...
describe('referencePoint.list.controller', function () {
  ...
  it('#init', function() {
    ...
    $httpBackend
      .when('GET', '/api/referencePoints?q=some+search')
      .respond(200, {});


    var controller = $controller('ReferencePointListController', { $scope: $scope, $state: stateMock });
    $httpBackend.flush();
